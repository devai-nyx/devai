...
export const ACTION_REGISTRY = [
  {
    ...
    "description": "Generate a starter .github/workflows/devai-gates.yml that calls the canonical reusable-evidence-gate.yml. Plan-only unless --write; refuses to overwrite unless --force (D-123, item 5).",
    "promotion_criteria": [],
  ...
  },
  {
    ...
    "effect": "local-write",
    "authority": "mesh_controller",
    "description": "Wire a devai check into a local git hook (husky-aware, idempotent via a marker block). Plan-only unless --write (D-123, item 5).",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "disposition": "keep",
    "lifecycle": "supported",
    "lifecycle_reason": "Supported specifier action in the 0.5 command contract.",
    "migration": null,
    "never_remint": true,
    "visibility": "standard",
    "tier": "plumbing",
  ...
  },
  {
    ...
    "disposition": "keep",
    "lifecycle": "supported",
    "lifecycle_reason": "Supported host_tooling action in the 0.5 command contract.",
    "migration": null,
    "never_remint": true,
    "visibility": "standard",
    "tier": "plumbing",
    ...
    "description": "Resolve which stack-adapter pack matches the current repo (or --adopter-root); report match + priority.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "disposition": "keep",
    "lifecycle": "supported",
    "lifecycle_reason": "Supported agent_runtime action in the 0.5 command contract.",
    "migration": null,
    "never_remint": true,
    ...
    "description": "Round-trip a prompt through the configured LLM provider; print response + usage telemetry.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "local-write",
    "authority": "mesh_controller",
    "description": "Generate the CLI reference under docs/reference/cli/ from the action catalog. --check fails on drift (byte-identity gate, Phase 13.C).",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "mesh_controller",
    "description": "Render the canonical per-record decision ledger to stdout; --out writes the same deterministic bytes with explicit consent.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "mesh_controller",
    "description": "Audit markdown cross-references across docs/** plus root-level markdown (README.md, CONTRIBUTING.md, ...). Reports broken file links (in-page anchors are not checked). Phase 13.C; root-level scan per D-131.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "disposition": "keep",
    "lifecycle": "supported",
    "lifecycle_reason": "Supported release_controller action in the 0.5 command contract.",
    "migration": null,
    "never_remint": true,
    "visibility": "advanced",
    "tier": "porcelain",
    ...
    "description": "Build and force-push docs/site to the gh-pages branch (orphan + with-lease). Three-stage flow: detect → build → publish. Per ADR-LOCAL-PUBLISH-WORKFLOW.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "mesh_controller",
    "description": "Render sealed round records to stdout; --out writes the same deterministic bytes with explicit consent.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "local-write",
    "authority": "specifier",
    "description": "Synthesize a brownfield doc from inventory sensor bodies via a SKILL-write-* writer",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "mesh_controller",
    "description": "Composite repo health check. Posture: --self (full DEVAI checks), --adopter (subset that applies to adopter repos), --auto (default; sniff repo-root for DEVAI shape).",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "authority": "mesh_controller",
    "description": "Validate an imported Actions shadow tuple and append its byte-exact digests to the Article-32 evidence chain.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "harness-write",
    "authority": "mesh_controller",
    "description": "Aggregate per-package Istanbul coverage-summary.json files into one composite summary feeding `render matrix` and `score compute`. Example: `devai evidence coverage aggregate --in coverage --out .devai/state/coverage/summary.json --per-package`.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "disposition": "keep",
    "lifecycle": "supported",
    "lifecycle_reason": "Supported policy_firewall action in the 0.5 command contract.",
    "migration": null,
    "never_remint": true,
    "visibility": "standard",
    "tier": "porcelain",
  ...
  },
  {
    ...
    "effect": "harness-write",
    "authority": "mesh_controller",
    "description": "Apply a redaction policy to a record, re-link downstream, and log a redaction event",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "harness-write",
    "authority": "mesh_controller",
    "description": "Render a (scope × tier) test-result matrix as Markdown or HTML. Reads test-result.schema.json-conformant records under .devai/state/test-results/. Example: `devai evidence test matrix --format md --out reports/matrix.md`.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "harness-write",
    "authority": "mesh_controller",
    "description": "Run a test command, capture stdout/stderr + exit code, and emit a test-result.schema.json record under .devai/state/test-results/. Example: `devai evidence test record --tier unit --scope @my/pkg --cmd \"pnpm --filter @my/pkg test:unit\" --chain`.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "lifecycle_reason": "D-126: autonomous preparation is opt-in and cannot merge, complete, or discard recoverable work.",
    "migration": null,
    "never_remint": true,
    "visibility": "advanced",
    "tier": "plumbing",
  ...
  },
  {
    ...
    "effect": "harness-write",
    "authority": "mesh_controller",
    "description": "Process merge-bound observations through the verified persistent post-merge host adapter",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "harness-write",
    "authority": "mesh_controller",
    "description": "Validate and record a phase/round closure (phase-closure.schema.json) under record/proofs/compliance/closures/",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "mesh_controller",
    "description": "Compute the closure ledger (no-deletion streak, batch counts, gate history) from recorded closures",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "harness-write",
    "authority": "mesh_controller",
    "description": "Emit a Reference Gap Report (RGR) draft. Persists under .devai/state/rgr/RGR-NNNN.json. Per Article 22 and Phase 11.C / D-39.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "mesh_controller",
    "description": "Classify a SensorReading failure (plant_bug | sensor_error | policy_issue | reference_gap | inconclusive)",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "sensor",
    "description": "Reverse-direction adherence audit: surfaces from the inventory that are not claimed by any invariant.code_areas in trace.json. Per Phase 11.F (D-39).",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "sensor",
    "description": "Normalize coverage-final.json into a flat summary. With --fail-under, gate against thresholds.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "harness-write",
    "authority": "specifier",
    "description": "Propose INV-CANDIDATE records from inventory sensor outputs (the brownfield-adoption bridge)",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "disposition": "keep",
    "lifecycle": "supported",
    "lifecycle_reason": "R25 binding analyzer; under-declaration, unresolved edges, and unregistered subprocesses fail closed.",
    "migration": null,
    "never_remint": true,
    "visibility": "advanced",
    "tier": "plumbing",
    ...
    "effect": "read",
    "authority": "policy_firewall",
    "description": "Run the binding action-effect analyzer and emit its deterministic SensorReading (F5×T4).",
    "promotion_criteria": [
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "policy_firewall",
    "description": "Validate ADR shape (front-matter + mandatory sections + sequential numbering). Absorbs LAW-14.ADR.*.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "policy_firewall",
    "description": "Validate .github/workflows/ against ADR-CI-ECONOMY: cancel-in-progress concurrency on PR workflows, no macOS on pull_request, no pull_request+push+schedule triple triggers, evidence gate wired. Rules 1-3 always hard-fail; rule 4 (evidence-gate-wired) is hard under the default \"full\" CI-economy profile and downgrades to advisory (still reported) when the target repo declares ci_economy.profile: \"gate-staged\" in .devai/config/project.json (D-116). Judgment rules (path filters, cron cadence, macOS cost, scheduled audit, DB isolation) are advisory.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "policy_firewall",
    "description": "Evaluate pinned pnpm@10.0.0 and npm@11.14.1 audit output over pnpm-lock.yaml and docs/site/package-lock.json; block high/critical advisories and invalid waivers, and fail closed on unavailable, malformed, stale, or mismatched provenance.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "policy_firewall",
    "description": "Validate repo against ADR-DOCS-GOVERNANCE: classification, builder choice, opt-out ADR, site-dir shape, build toolchain, gh-pages branch, and no-CI-publish rule. Hard-fail gate per ADR-DOCS-GOVERNANCE Decision 6.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "policy_firewall",
    "description": "Scan recent git commits for matches against .devai/config/forbidden-actions.json. Absorbs LAW-12.FORBID.1.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "policy_firewall",
    "description": "Evaluate .devai/config/glob-guards.json: every registered pattern must still match at least min_matches files. Catches a CI trigger path, generator input dir, or validation-loop target silently degrading to zero matches after a rename or format migration.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "policy_firewall",
    "description": "Scan source for inv-override annotations; validate against invariant catalog + severity + expiry. Absorbs LAW-00.OVERRIDE.1.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "policy_firewall",
    "description": "Parse + validate the Inv-Compliance: PR trailer. Absorbs LAW-00.READING.2 / LAW-12.CITE.1.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "policy_firewall",
    "description": "Inspect skill manifests for authority-inversion: scopes granting Constructor-tier writes over Architect/Owner/Inspector-reserved paths. Per Phase 12.B (D-42).",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "policy_firewall",
    "description": "Flag SensorReadings that share a command_hash across distinct sensor.kind values (relabeled, not independently measured). Advisory: exits REVIEW on findings, never FAIL.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "harness-write",
    "authority": "release_controller",
    "description": "Compute a deploy-gate decision from scorecard + sensor evidence + invariant state. Persists under .devai/state/releases/REL-NNNN.json. Per Phase 11.B (D-39).",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "harness-write",
    "authority": "release_controller",
    "description": "Detect or record runtime drift. Either record form (operator supplies --observation surface=delta pairs) or detector form (operator supplies --runtime-charter <path> to an api/auth charter; each failed/errored probe is translated into a drift observation).",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "local-write",
    "authority": "specifier",
    "description": "Validate a public round-record JSON input and declare it in the local round workspace.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "mesh_controller",
    "description": "Read one local or archived governed round and report its schema-valid canonical status.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "disposition": "fold",
    "lifecycle": "retired",
    "lifecycle_reason": "Historical per-sensor wrapper folded into the governed generic sensor runner.",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "sensor",
    "description": "Cross-check machine-derivable reference-doc claims against ground truth; emit a docs_drift SensorReading (F5×T3)",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "sensor",
    "description": "Static backend-API inventory (NestJS adapter, tier L0); emit SensorReading + api-map body",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "sensor",
    "description": "Static data-model inventory (Postgres SQL migration parser, tier L0); emit SensorReading + body",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "sensor",
    "description": "Aggregate persisted inventory_* SR durations into a p95-based verdict (F4×T7, Phase 29.F / R-1)",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "sensor",
    "description": "Static RBAC inventory inferred from data-model output (tier L0); emit SensorReading + rbac body",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "harness-write",
    "authority": "sensor",
    "description": "Run mutation scenarios and emit `.devai/state/mutation/current.json` in the shape `verify-mutation` consumes. Per D-A-44 / ADR-MUTATION-SCENARIOS.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "local-write",
    "authority": "sensor",
    "description": "Compare the current mutation report with its baseline and thresholds. Exits non-zero on regression or threshold breach.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "harness-write",
    "authority": "sensor",
    "description": "Synthesize SensorReadings from existing .devai/state/sensors/<verb>/ bodies into .devai/state/sensor-readings/ (Phase 21.E).",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "harness-write",
    "authority": "sensor",
    "description": "Validate and idempotently persist one exact SensorReading artifact with chained provenance",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "sensor",
    "description": "Run a deterministic sensor preset for an adoption tier; --dry-run prints the exact expansion.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "sensor",
    "description": "Execute an HTTP/RPC runtime-probe charter against a deployed runtime and emit a SensorReading. Per Phase 11.A (D-39).",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "sensor",
    "description": "Execute an auth/RBAC/protected-surface runtime-probe charter and emit a SensorReading. Per Phase 11.A (D-39).",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "sensor",
    "description": "Execute a data/state/consistency runtime-probe charter and emit a SensorReading. DB driver placeholder; --dry-run validates the charter without executing. Per Phase 11.A (D-39).",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "sensor",
    "description": "Compare local gh-pages provenance with repository and package history; emit a site_drift SensorReading",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "sensor",
    "description": "Run invariant validator with --strict-cnl and emit a spec_idiomaticity SensorReading (F1×T5)",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "specifier",
    "description": "Compare a module-blueprint to brownfield inventory; emit deltas (the bridge between brownfield and greenfield)",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "harness-write",
    "authority": "mesh_controller",
    "description": "Append a resolution record to the decisions ledger (closed | superseded | invalidated). Original DEC record is not modified. Per D-A-42.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "harness-write",
    "authority": "specifier",
    "description": "Build a hash-stamped RTD manifest aggregating invariants, trace, journeys, glossary, tombstones, ADRs, and forbidden-actions. Per Phase 12.A (D-41).",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "read",
    "authority": "specifier",
    "description": "Gate: every registered action is claimed by at least one invariant.measurable_via. Closes Batch 9.A.3.",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
  ...
  },
  {
    ...
    "effect": "harness-write",
    "authority": "mesh_controller",
    "description": "Spawn a task: acquire locks; optionally create worktree and provision per-task DB (atomic with rollback on failure)",
    "promotion_criteria": [],
    "authority_contract_version": "1.0.0",
    "authority_contract": {
      "schemaVersion": "1.0.0",
