...
**Scope:** the mechanical authority boundary shipped by DEVAI under Constitution
Articles 6–10 and the current authority policy.
...
4. An independent reviewer observes the resulting candidate.
