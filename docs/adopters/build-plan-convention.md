...
- *"Phase 32"* → project-lifecycle phase (unambiguous: integer).
- *"R3-W2-A"* → round-execution phase (unambiguous: full path).
- *"the audit phase of R3-W4"* → unambiguous: phase as a role within wave, not an integer.
- *"phase B of the wave"* → unambiguous: lower-case "phase" + letter, round-execution scope.
