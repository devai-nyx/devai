...
supersedes: null
superseded_by: null
provenance: [R-0004-AS-BUILT; DII-184; source snapshot 31dfbaf3d8b51e2089aef6aa01ea45b46d9b266c]
---

# R-0004 exact-candidate ladder pass

The complete local R-0004 exit ladder passed on exact source snapshot
`31dfbaf3d8b51e2089aef6aa01ea45b46d9b266c` with a clean worktree.
...
- T2: 38 files / 236 passed / 1 declared skip;
...
- root `pnpm run test`: 127 files / 1,161 passed / 8 declared skips;
