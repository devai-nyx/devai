...
The complete tiered exit ladder passed on exact source snapshot `54e79a1`:
...
The root `pnpm run test` porcelain passed 127 files / 1,166 tests with 8 declared skips
