...
provenance:
  [
    R-0004-ENTRY-MEASUREMENT; R-0004-SURFACE-DISPOSITION; R-0004-OPUS-CLOSE-REVIEW-8-CORRECTION; source snapshot dc64176017ad07c956548b47e59955862541db21,
  ]
---
...
`dc64176017ad07c956548b47e59955862541db21`. The governed surface and package
...
| BL-167–170 | Implemented; ceremony pending              | All 147 command bindings—144 literal AST definitions plus three exact init-factory invocations—have metadata parity; audit lifecycle links resolve; test variants/provenance are complete; strict AST typing is green. |
...
The complete tiered exit ladder passed on exact source snapshot `dc64176`:
...
The root `pnpm run test` porcelain passed 127 files / 1,165 tests with 8 declared skips
