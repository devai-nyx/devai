...
After a fresh GRANTED mandate, read OM-002, the shared execution contract, this plan,
R-0008 published audit, R-0009 zero-baseline handoff, current promotion law, raw evidence
schemas, revocation behavior, scorecard-skill manifests, and all qualifying-run
classifiers.
...
qualifier. Keep raw evidence and exclusions. Ask Claude Fable 5 at each checkpoint to
