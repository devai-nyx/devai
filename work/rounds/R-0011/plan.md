...
supersedes: null
superseded_by: null
provenance: [OM-002; OM-019; BL-022; BL-036; ADR-003; R-0010 published close]
---
...
R-0010 Phase B is published, independently verified, and closed; source PRs still run
...
| ----- | ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------- |
| B0    | Architect                | Declare R-0011 with streak zero; freeze successor authorization/revocation shapes and qualifying-run definitions from accepted law                                         | No predecessor-standing import           |
...
| B6    | Architect + machine verb | Close R-0011                                                                                                                                                               | R-0010 still pending                     |
