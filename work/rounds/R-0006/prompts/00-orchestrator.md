...
Execute B0 through B9. Freeze the starting denominator and config in the round audit.
The Architect makes two separate BL-035 decisions. The Inspector writes behavior-first
reds and coverage tests; the Engineer fixes the plant and measurement plumbing. Never
