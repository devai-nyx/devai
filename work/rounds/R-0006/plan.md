...
supersedes: null
superseded_by: null
provenance: [OM-002; OM-010; OM-011; OM-012; OM-013; BL-026; BL-034; BL-035; BL-081]
---
...
| B9    | Architect + machine verb | Converge with content-addressed task freshness, generate the exhaustive review-scope census, rehearse, review under the OM-012 review-until-PASS protocol with OM-013's R-0006-only independent Codex substitution, publish, and close through the source and closure-only PRs | Every identity, cache decision, review topic, clone, envelope, and exact-SHA check green |
