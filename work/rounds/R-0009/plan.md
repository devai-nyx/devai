...
superseded_by: null
provenance:
  [OM-002; OM-019; R-0007 canonical-reference handoff; BL-019; BL-021; BL-032; BL-039; BL-044]
---
...
Consume the R-0007 canonical descriptor handoff, apply the approved semantic product dispositions, generate the complete CLI reference
...
R-0008 is merged and closed; 70/60/70/70 and all production gates are green; action and
...
the declaration-bearing `round-close:entry-check -- --round R-0009` runs **after** B0
and before B1. The reviewer binding is `claude-opus-5` under OM-017 as retained by
OM-018; an inactive, ambiguous, or conflicting binding means R-0009 remains dormant.
