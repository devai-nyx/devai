...
Do not execute unless R-0008’s published phase is closed. Read OM-002, OM-003, the
shared contract, R-0009 authorization/plan, published R-0008 audit, ADR-003/005,
...
Ask Claude Opus 5 to attack self-authorization, head-only authorization, revocation,
