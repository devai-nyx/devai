...
This note binds the successor-local design standing for `spec_robustness_targets`. Its canonical emitter
is `packages/sensors/src/spec-robustness-targets.ts`; R-0004 does not change its measured runtime semantics.
