...
This note binds the successor-local design standing for `harness_green_main`. Its canonical emitter
is `packages/sensors/src/harness-green-main.ts`; R-0004 does not change its measured runtime semantics.
